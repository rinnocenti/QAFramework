...
| `Descriptors/Editor/QaB1DescriptorEqualitySmoke.cs` / `QaB1DescriptorEqualitySmoke` | `Immersive Framework QA/Contracts/B1 Run Descriptor Equality Smoke` | Descriptors | Igualdade funcional de Actor e PlayerActor, independente de caminho/reparent. | E, T; paths sintéticos, nenhum asset persistido. | Não | Nenhum equivalente completo. | **FINAL** |
...
- **Domínio:** Contracts
- **Contrato provado:** igualdade/hash funcionais de Actor e PlayerActor.
...
### 5.12 Player Participation Authoring Regression
...
### 5.13 Session Player Slots Regression
...
### 5.14 Local Player Provisioning Regression
...
### 5.15 Scene Player Route Lifecycle Regression
...
### 5.16 Player Gameplay Admission Regression
...
### 5.17 Player Input Mode Authority Regression
...
### 5.18 Pause Product Binding Regression
...
### 5.19 Local Player Camera Publication Regression
...
### 5.20 Camera Follow Authoring Regression
...
### 5.21 Camera Override Authority Regression
...
### 5.22 Audio Playback Regression
...
### 5.23 Pooling Runtime Regression
...
3. Consolidar Object Reset (registration + unit + group).
...
- **SceneIndependent:** 16 regressões.

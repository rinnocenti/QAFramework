...
## Current QA-02 execution path

The former standalone Transition/Loading prefab paths are not present in the current
checkout. IF-READY-04-QA-02 does not reconstruct them; it creates a bounded
runtime-synthetic fixture from the current adapter types. This is the current QA-02
execution path, distinct from the historical F24 documentation below.

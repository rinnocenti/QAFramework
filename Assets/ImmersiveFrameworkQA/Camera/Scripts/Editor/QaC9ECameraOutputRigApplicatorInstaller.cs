...
{
    public static class QaC9ECameraOutputRigApplicatorInstaller
    {
        ...
        private const string ScenePath =
            CameraRoot + "/Scenes/QA_CameraOutputRigApplicator.unity";
        private const string RoutePath =
            CameraRoot + "/Routes/QA_CameraOutputRigApplicatorRoute.asset";
        private const string ActivityPath =
            CameraRoot + "/Activities/QA_CameraOutputRigApplicatorActivity.asset";
        ...
        private const string HubReason =
            "qa.hub.route.camera_output_rig_applicator";
        private const string HubTriggerName =
            "RouteTrigger_Camera_C9E_Output_Rig_Applicator";

        [MenuItem("Immersive Framework QA/Camera/C9E Install Camera Output Rig Applicator QA")]
        public static void Install()
        {
            try
            {
                ...
                Debug.Log(
                    "[C9E_CAMERA_OUTPUT_RIG_APPLICATOR_SETUP] status='Succeeded' " +
            ...
            {
                Debug.LogError(
                    "[C9E_CAMERA_OUTPUT_RIG_APPLICATOR_SETUP] status='Failed' " +
        ...
        [MenuItem("Immersive Framework QA/Camera/C9E Open Camera Output Rig Applicator Scene")]
        ...
        private static void CreateOrRepairRouteAssets()
        {
            ...
            SetString(
                activitySerialized,
                "activityName",
                "QA C9E Camera Output Rig Applicator Activity");
            SetString(
                activitySerialized,
                "description",
                "Synthetic runtime activity proving materialized Cinemachine rig application.");
            ...
            SetString(
                routeSerialized,
                "routeName",
                "QA C9E Camera Output Rig Applicator");
            SetString(
                routeSerialized,
                "primaryScenePath",
                ScenePath);
            ...
            SetString(
                routeSerialized,
                "description",
                "QA route for C9E CameraOutputRigApplicator runtime.");
        ...
        private static void CreateOrRepairSyntheticScene()
        {
            ...
            scene.name = "QA_CameraOutputRigApplicator";

            GameObject outputObject =
                new GameObject("QA_C9E_Output");
            ...
            outputCamera.backgroundColor =
                new Color(0.025f, 0.025f, 0.055f, 1f);
            outputObject.transform.position =
                new Vector3(0f, 0f, -10f);

            GameObject root =
                new GameObject("QA_C9E_CameraOutputRigApplicator");
            ...
            CameraRigComposer playerComposer =
                CreateMaterializedComposer(
                    root.transform,
                    "PlayerRig",
                    "Player Cinemachine Camera",
                    out CinemachineCamera playerCamera);
            ...
            QaC9ECameraOutputRigApplicatorFixture fixture =
                root.AddComponent<QaC9ECameraOutputRigApplicatorFixture>();
            ...
            if (!EditorSceneManager.SaveScene(scene, ScenePath))
            {
                throw new InvalidOperationException(
                    $"Could not save C9E scene at '{ScenePath}'.");
            }
        }
        ...
        private static void ValidateSyntheticScene()
        {
            ...
            QaC9ECameraOutputRigApplicatorFixture fixture =
                FindSingleInScene<QaC9ECameraOutputRigApplicatorFixture>(
                    scene,
            ...
            {
                throw new InvalidOperationException(
                    $"Expected three CameraRigComposers in C9E scene, found '{composers.Length}'.");
            }
        ...
        private static void ValidateHubEntry()
        {
            ...
            {
                throw new InvalidOperationException(
                    "Saved QA Hub does not contain the C9E trigger object.");
            }
            ...
            {
                throw new InvalidOperationException(
                    "Saved C9E Hub trigger has no valid TargetRoute.");
            }
            ...
            {
                throw new InvalidOperationException(
                    $"Saved C9E Hub trigger Route path is '{actualPath}', expected '{expectedPath}'.");
            }
            ...
            {
                throw new InvalidOperationException(
                    $"Expected exactly one valid C9E Hub entry, found '{matchingEntries}'.");
            }
        }

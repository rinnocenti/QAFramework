...
{
    // Legacy path retains the script meta; C9R is the only installed QA surface.
    internal static class QaC9RCameraOverrideAuthoritySceneInstaller
    {
        ...
        private static void RepairScene()
        {
            ...
            Set(player, "actorId", "qa.player.actor.c9r"); Set(player, "playerSlotId", "qa.player.slot.1");

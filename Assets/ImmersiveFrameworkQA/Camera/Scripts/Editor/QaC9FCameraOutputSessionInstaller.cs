...
{
    public static class QaC9FCameraOutputSessionInstaller
    {
        ...
        private const string ScenePath =
            CameraRoot + "/Scenes/QA_CameraOutputSession.unity";
        private const string RoutePath =
            CameraRoot + "/Routes/QA_CameraOutputSessionRoute.asset";
        private const string ActivityPath =
            CameraRoot + "/Activities/QA_CameraOutputSessionActivity.asset";
        ...
        private const string HubLabel =
            "Camera / C9F Output Session";
        private const string HubReason =
            "qa.hub.route.camera_output_session";
        private const string HubTriggerName =
            "RouteTrigger_Camera_C9F_Output_Session";

        [MenuItem("Immersive Framework QA/Camera/C9F Install Camera Output Session QA")]
        public static void Install()
        {
            try
            {
                ...
                Debug.Log(
                    "[C9F_CAMERA_OUTPUT_SESSION_SETUP] status='Succeeded' " +
            ...
            {
                Debug.LogError(
                    "[C9F_CAMERA_OUTPUT_SESSION_SETUP] status='Failed' " +
        ...
        [MenuItem("Immersive Framework QA/Camera/C9F Open Camera Output Session Scene")]
        ...
        private static void CreateOrRepairRouteAssets()
        {
            ...
            SetString(
                activitySerialized,
                "activityName",
                "QA C9F Camera Output Session Activity");
            SetString(
                activitySerialized,
                "description",
                "Synthetic runtime activity proving transactional camera output coordination.");
            ...
            SetString(
                routeSerialized,
                "description",
                "QA route for C9F CameraOutputSession transactional coordination.");
        ...
        private static void CreateOrRepairSyntheticScene()
        {
            ...
            scene.name = "QA_CameraOutputSession";

            GameObject outputObject =
                new GameObject("QA_C9F_Output");
            ...
            outputCamera.backgroundColor =
                new Color(0.02f, 0.04f, 0.06f, 1f);
            outputObject.transform.position =
                new Vector3(0f, 0f, -10f);

            GameObject root =
                new GameObject("QA_C9F_CameraOutputSession");
            ...
            QaC9FCameraOutputSessionFixture fixture =
                root.AddComponent<QaC9FCameraOutputSessionFixture>();
            ...
            if (!EditorSceneManager.SaveScene(scene, ScenePath))
            {
                throw new InvalidOperationException(
                    $"Could not save C9F scene at '{ScenePath}'.");
            }
        }
        ...
        private static void ValidateSyntheticScene()
        {
            ...
            QaC9FCameraOutputSessionFixture fixture =
                FindSingleInScene<QaC9FCameraOutputSessionFixture>(
                    scene,
            ...
            {
                throw new InvalidOperationException(
                    $"Expected three CameraRigComposers in C9F scene, found '{composers.Length}'.");
            }
            ...
            AssertNonNullReference(serialized, "playerComposer");
        ...
        private static void ValidateHubEntry()
        {
            ...
            {
                throw new InvalidOperationException(
                    "Saved QA Hub does not contain the C9F trigger object.");
            }
            ...
            {
                throw new InvalidOperationException(
                    "Saved C9F Hub trigger has no valid TargetRoute.");
            }
            ...
            {
                throw new InvalidOperationException(
                    $"Saved C9F Hub trigger Route path is '{actualPath}', expected '{expectedPath}'.");
            }
            ...
            {
                throw new InvalidOperationException(
                    $"Expected exactly one valid C9F Hub entry, found '{matchingEntries}'.");
            }
        }

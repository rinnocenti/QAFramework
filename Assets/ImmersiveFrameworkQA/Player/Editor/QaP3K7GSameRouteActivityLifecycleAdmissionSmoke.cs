...
namespace ImmersiveFrameworkQA.Player.Editor
{
    ...
    /// same-Route Activity lifecycle admission integration.
    /// </summary>
    public static class QaP3K7GSameRouteActivityLifecycleAdmissionSmoke
    {
        private const string MenuPath =
            "Immersive Framework/QA/Player/P3K.7G Run Same-Route Activity Lifecycle Admission Smoke";
        ...
        public static async void Run()
        {
            ...
            try
            {
                AssertTrue(EditorApplication.isPlaying,
                    "P3K.7G lifecycle admission smoke must run in Play Mode.");
                ...
                AssertTrue(initialGameplay.LifecycleAdmission != null,
                    "P3K.7G lifecycle admission snapshot is missing.");
                AssertEqual(ActivityPlayerLifecycleAdmissionState.None,
                    initialGameplay.LifecycleAdmission.State,
                    "P3K.7G lifecycle admission is not initially clean.");
                ...
                AssertEqual(0, manager.playerCount,
                    "P3K.7G smoke is one-shot. Re-enter Play Mode before running again.");

                PlayerParticipationOperationResult opened =
                    Invoke<PlayerParticipationOperationResult>(
                        preparationModule,
                        "TryOpenJoining",
                        nameof(QaP3K7GSameRouteActivityLifecycleAdmissionSmoke),
                        "same-route-lifecycle-admission");
                ...
                object requestResult = await InvokeTaskResultAsync(
                    ...
                    targetActivity,
                    nameof(QaP3K7GSameRouteActivityLifecycleAdmissionSmoke),
                    "same-route-gameplayready-switch");
                AssertTrue(GetBooleanProperty(requestResult, "Succeeded"),
                    "Same-Route Activity request failed. " +
                    GetStringProperty(requestResult, "Message"));
                completed.Add("same-route-activity-request-succeeded");
                ...
                AssertNotNull(lifecycle,
                    "P3K.7G lifecycle admission evidence is missing after switch.");
                AssertTrue(lifecycle.IsCompleted,
                    "P3K.7G lifecycle admission did not complete. " +
                ...
                PlayerParticipationOperationResult closed =
                    Invoke<PlayerParticipationOperationResult>(
                        ...
                        "TryCloseJoining",
                        nameof(QaP3K7GSameRouteActivityLifecycleAdmissionSmoke),
                        "same-route-lifecycle-admission-complete");
                ...
                AssertEqual(40, completed.Count,
                    "P3K.7G smoke case count changed unexpectedly.");
                Debug.Log(
                    ...
                    $"target='{targetActivity.ActivityName}' " +
            ...
            List<UnityEngine.Object> created)
        {
            ...
            projection.name = "P3K.7G Explicit Player";
            ...
            requirements.name = "P3K.7G Gameplay Ready";
            ...
            activity.name = "P3K.7G Target Activity";

...
{
    /// <summary>
    /// Narrow friend-assembly observation seam for legacy default-assembly QA
    /// runners. It converts internal host composition into existing public
    /// immutable contracts; it neither changes runtime state nor creates a
    /// second Player authority.
    /// </summary>
    public static class QaPlayerRuntimeObservationBridge
    {
        ...
        /// <summary>
        /// Read-only typed access to the provisioning surface already composed
        /// on the runtime host. This is QA observation only: it neither
        /// discovers authoring globally nor changes its lifetime.
        /// </summary>
            ...
            out string diagnostic)
        {
            ...
            {
                diagnostic =
                    "Framework Local Player provisioning runtime is unavailable.";
                return false;
            }
        ...
        public static QaAutomaticSceneAdmissionResolution
            ResolveAutomaticSceneAdmission(
                Component hostComponent,
        ...
        {
            if (hostComponent is not FrameworkRuntimeHost host ||
                !owner.IsValid || host.RuntimeContentRuntime == null)
            {
                return 0;
            }
        ...
        public static bool IsReady(Component hostComponent) =>
            hostComponent is FrameworkRuntimeHost host && host.State.GameFlowStarted &&
            ...
            string reason)
        {
            ...
            {
                throw new System.InvalidOperationException(
                    "P3M5B runtime host is unavailable for Route request plumbing.");
            }
    ...
    {
        public QaRouteRequestObservation(
            bool succeeded,
            bool activityReady,
            string message)
        {
    ...
    {
        public QaAutomaticSceneAdmissionResolution(
            bool succeeded,
            int count,
            string issue)
        {

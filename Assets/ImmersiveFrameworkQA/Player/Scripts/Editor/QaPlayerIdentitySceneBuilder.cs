...
{
    /// <summary>
    /// Editor-only deterministic builder for the synthetic Actor, PlayerSlot, Reset Bridge, Gate Bridge and Pause InputMode Bridge QA scene.
    /// </summary>
    public static class QaPlayerIdentitySceneBuilder
    {
        ...
        private static void CreateScene()
        {
            ...
            Text summary = CreateText(
                ...
                "Actor + PlayerSlot + Reset + Gate + PauseInputMode Bridge QA | passes=0 failures=0",
                new Vector2(0f, 260f),
            ...
            Text result = CreateText(
                ...
                "Idle. Run an Actor, PlayerSlot, Reset Bridge, Gate Bridge, or Pause InputMode Bridge QA probe.",
                new Vector2(0f, 125f),

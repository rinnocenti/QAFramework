    ...
    public static class QaPlayerActorSelectionRuntimeBindingRegression
    {
        ...
        public static async Task RunRegressionAsync()
        {
            ...
            try
            {
                ...
                Debug.Log(
                    $"{LogPrefix} status='Passed' cases='13' " +
            ...
            ICollection<string> completed)
        {
            ...
            Require(
                ...
                optionalAbsent.BoundCount == 0 &&
                optionalAbsent.RejectedCount == 0,
            ...
            LocalPlayerActorSelectionRequestAuthoringReleaseResult optionalRelease =
                LocalPlayerActorSelectionRequestAuthoringBinding.TryRelease(
                    ...
                    hostRuntime);
            Require(
                optionalRelease.Succeeded &&
                optionalRelease.Status == "OptionalAbsent" &&
                optionalRelease.RootCount == 1 &&
                optionalRelease.AuthoringCount == 0 &&
                optionalRelease.ReleasedCount == 0 &&
                optionalRelease.RejectedCount == 0,
                optionalRelease.Message);
            completed.Add("optional-absent-selection-release-is-non-blocking");

...
namespace ImmersiveFrameworkQA.GameFlow.Internal.Editor
{
    ...
    public static class QaPlayerProvisioningPublicSurfaceRegression
    {
        ...
        private static async Task RunAsync(bool terminateSession = false)
        {
            ...
            if (terminateSession)
            {
                expectedCases.Add("session-termination-preconditions");
                expectedCases.Add("session-termination-physical-resources-released");
                expectedCases.Add("session-termination-public-evidence-cleared");
            }

...
{
    /// <summary>
    /// Optional Inspector bridge for ActivityRequestTrigger Foundation events.
    /// The trigger remains the typed event publisher; this component only adapts those events to UnityEvent callbacks.
    /// </summary>
    [DisallowMultipleComponent]
    [RequireComponent(typeof(ActivityRequestTrigger))]
    [AddComponentMenu("Immersive Framework/Activity Request Trigger Unity Event Bridge")]
    [FrameworkApiStatus(FrameworkApiStatus.Experimental, "Baseline surface kept for development use until the owning roadmap phase stabilizes it.")]
    public sealed class ActivityRequestTriggerUnityEventBridge : MonoBehaviour
    {
        private ActivityRequestTrigger _trigger;
        ...
        {
            _trigger = GetComponent<ActivityRequestTrigger>();
            _binding = _trigger.SubscribeRequestEvents(OnActivityRequestEvent);
        }

            ...
            string reason)
        {
            ...
            if (applicationPreview == null || !applicationPreview.Succeeded)
            {
                ...
                return CreateResult(
                    ...
                    actionMapName,
                    actionMapPreview != null && actionMapPreview.ActionMapRequired,
                    actionMapPreview != null && actionMapPreview.ActionMapAvailable,
                    applicationPreview != null && applicationPreview.PlayerActorRequired,
                    applicationPreview != null && applicationPreview.SessionPlayerInputManagerRequired,
                    issues,
                    normalizedSource,
                    reason);
            }

...
Use `Documentation~/Guides/F20-Pause-State-Gate-Usage.md` for the current usage boundary and QA smokes. F21 is the next phase for Pause content, overlay and input boundary.

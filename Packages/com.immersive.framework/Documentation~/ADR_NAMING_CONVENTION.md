...
| `ADRs/F7-surface-declaration/01-ADR-SURFACE-001-surface-as-space-contract.md` | `ADRs/F7-surface-declaration/F7-01-ADR-SURFACE-001-surface-as-space-contract.md` |
...
| `ADRs/F9-surface-binding-and-runtime-placement/01-ADR-SURFACE-002-surface-binding-and-content-placement.md` | `ADRs/F9-surface-binding-and-runtime-placement/F9-01-ADR-SURFACE-002-surface-binding-and-content-placement.md` |
| `ADRs/F10-consumers-intermedi-rios/01-ADR-INPUT-001-input-ownership.md` | `ADRs/F10-consumers-intermedi-rios/F10-01-ADR-INPUT-001-input-ownership.md` |
| `ADRs/F10-consumers-intermedi-rios/02-ADR-PAUSE-001-pause-as-surface-input-activity-consumer.md` | `ADRs/F10-consumers-intermedi-rios/F10-02-ADR-PAUSE-001-pause-as-surface-input-activity-consumer.md` |
| `ADRs/F10-consumers-intermedi-rios/03-ADR-SAVE-001-snapshot-envelope-and-schema.md` | `ADRs/F10-consumers-intermedi-rios/F10-03-ADR-SAVE-001-snapshot-envelope-and-schema.md` |
| `ADRs/F11-consumers-avan-ados/01-ADR-ACTOR-001-actor-runtime-boundary.md` | `ADRs/F11-consumers-avan-ados/F11-01-ADR-ACTOR-001-actor-runtime-boundary.md` |
| `ADRs/F11-consumers-avan-ados/02-ADR-AUDIO-001-audio-as-lifecycle-consumer.md` | `ADRs/F11-consumers-avan-ados/F11-02-ADR-AUDIO-001-audio-as-lifecycle-consumer.md` |
| `ADRs/F11-consumers-avan-ados/03-ADR-CAMERA-001-camera-as-surface-consumer.md` | `ADRs/F11-consumers-avan-ados/F11-03-ADR-CAMERA-001-camera-as-surface-consumer.md` |
| `ADRs/F11-consumers-avan-ados/04-ADR-POOL-001-pooling-package-boundary.md` | `ADRs/F11-consumers-avan-ados/F11-04-ADR-POOL-001-pooling-package-boundary.md` |

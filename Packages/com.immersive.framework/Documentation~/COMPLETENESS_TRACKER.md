...
| F5 | `OPEN / LOCAL CONTRIBUTION` | F5C applied / pending compile-smoke | `Local/LOCAL_CONTENT_IDENTITY.md` |
...
|---|---|
| `F5C compile-smoke` | `F5B` passed Standard Smoke. `F5C` is applied and pending compile-smoke validation. |
| `F5D` | Authorized only after F5C compile-smoke passes. |

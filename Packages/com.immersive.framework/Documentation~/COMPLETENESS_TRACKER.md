...
| F9 | `OPEN / F9E APPLIED / HOST OWNERSHIP PENDING COMPILE` | F9D smoke regression passed; F9E makes FrameworkRuntimeHost own the logical binding runtime through controlled internal methods; compile/import pending | `Planning/F9Plus-Roadmap-Realignment.md`, `ContentAnchor/CONTENT_ANCHOR_BINDING_CONTRACTS.md`, `ContentAnchor/CONTENT_ANCHOR_BINDING_RUNTIME.md`, `ADRs/F9-content-anchor-binding-and-runtime-placement/` |
...
|---|---|
| Compile/import smoke | Confirms F9E host-owned binding runtime integration compiles in Unity. |

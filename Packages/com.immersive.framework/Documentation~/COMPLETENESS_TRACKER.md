...
|---|---|
| Compile/import smoke | Confirms F9C QA diagnostics and binding smoke compile in Unity. |
| Content Anchor Binding Smoke | Validates logical anchor binding, idempotent rebind, unbind, logical release and unregister without physical placement. |
...
F9+ was realigned after this point. F9A/F9B apply the first Content Anchor binding contracts and logical runtime without physical placement; F9C adds QA smoke diagnostics for the logical binding loop.

...
F21H closure note: F21 is closed as Save / Snapshot / Preferences / Progression Save Foundation. Use `Documentation~/Guides/F21-Save-Snapshot-Preferences-Progression-Usage.md`. Next cut: F22A - Loading Architecture ADR Plan.

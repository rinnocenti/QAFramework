...
| F17 | [Gate Boundary](F17-ADR-GATE-001-Gate-Boundary.md) | Accepted / F17B Primitives |
...
F17A/F17B note: Gate comes before Transition and Pause. Gate is not UI, readiness or input system; it decides admission of request, input, interaction or gameplay in explicit scopes and must produce decision/result/facts. F17B adds passive primitives only; request integration is deferred to F17C.

...
F0-F20 are closed/applied. F17 is Gate Foundation. F18 is Transition Orchestration Foundation. F19 is Transition Effects. F20 is Pause State/Gate. F21 is open for Save / Snapshot / Preferences / Progression Save Foundation; F21A is applied as a documentation-only ADR plan, F21B Snapshot Envelope Primitives are applied, and F21C Snapshot Participant Contracts + Diagnostics Smoke is applied. F21D Preferences Store Contracts + PlayerPrefs Backend is applied. F21E is next. F22 is planned for Loading Operation / Progress / Readiness Boundary. Pause Content/Overlay/Input moves to F23. Gameplay Adapter Foundation moves to F24.
...
Loading Operation/Progress/Readiness is F22.

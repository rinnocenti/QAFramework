...
F0-F19 are closed/applied. F17 is Gate Foundation. F18 is Transition Orchestration Foundation. F19 is Transition Effects. F20 is in progress through F20A.
...
```text
F20A is documentation/plan only. No scene, GameObject, Canvas, prefab or ScriptableObject is required.
...
Next cut: F20B - Pause State Primitives.
```

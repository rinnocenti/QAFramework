...
- `ADRs/` preserva decisoes aceitas de F0-F10 classificadas por fase; F10 ja possui contratos passivos, resultado agregado e contrato de participant de Activity Content Execution, sem discovery/runtime de execucao. Nao manter bucket `Unassigned`.

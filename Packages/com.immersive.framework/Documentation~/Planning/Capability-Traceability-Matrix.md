...
| Activity content lifecycle result | Criar como `ActivityContentLifecycleResult` | F4 | F4C | IF-FW-ROAD-4C | Presente mínimo / Pending smoke | Coberto | Core | Route handoff + ActivityContentSet | Baixo / controlado | F4C adiciona resultado agregado de callbacks locais enter/exit; não é release/loading. |

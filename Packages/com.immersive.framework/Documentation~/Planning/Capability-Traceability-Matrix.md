...
| Primary scene loading | Preservar; já existe no package | F3 | F3 | IF-FW-ROAD-3C | Presente / Integrado em F3D / Pendente smoke | Coberto | Core | Route baseline + Content identity | Baixo / controlado | RouteContentRuntime entra após load da Primary Scene e antes da Startup Activity. |
...
| Route → Activity handoff | Preservar boundary; reduzir payload | F3 | F3 | IF-FW-ROAD-3C | Integrado em F3D / Pendente smoke | Coberto | Core | Route baseline + Content identity | Baixo / controlado | RouteContentRuntime roda antes da Startup Activity. |
| Route startup activity policy | Preservar como policy simples | F3 | F3 | IF-FW-ROAD-3C | Preservado em F3D / Pendente smoke | Coberto | Core | Route baseline + Content identity | Baixo / controlado | Startup Activity continua depois do enter local da Route. |

...
| Activity content set | Preservar como `ActivityContentSet` | F4 | F4B | IF-FW-ROAD-4B | Parcial / Presente mínimo | Coberto | Core | Route handoff + ActivityContentSet | Baixo / controlado | F4B adiciona snapshot mínimo de conteúdo scene-authored local; profile/loading/release continuam fora. |

...
| Session runtime state | Preservar; tipar IDs | F2 | F2 | IF-FW-ROAD-2B | Parcial / Ausente | Coberto | Core | RuntimeContentHandle + ContributionSet + release policy | Baixo / controlado | Sem ajuste. |
...
| Session content set | Preservar como `SessionContentSet` | F2 | F2 | IF-FW-ROAD-2C | Parcial / Ausente | Coberto, mas com correção | Core | Baseline ADRs + API/identity policy | Baixo / controlado | Mantém F2, mas como set mínimo, possivelmente vazio/diagnóstico. |

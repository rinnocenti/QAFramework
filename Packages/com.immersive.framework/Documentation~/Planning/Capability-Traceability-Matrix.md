...
| Lifecycle integration for runtime roots | Conectar criação/remoção explícita de roots/contextos ao lifecycle | F8 | F8 | IF-FW-ROAD-8F | Implementado em F8F | Coberto / Aplicado | Foundation avançada | RuntimeContentRuntime + RuntimeScopeContext | Baixo / controlado | Session/Route/Activity criam/removem roots lógicos sem materializar prefab ainda. |
| Materialization request/result | Preservar como `RuntimeMaterializationRequest/Result` | F8 | F8 | IF-FW-ROAD-8G | Ausente / Próximo | Coberto / Next | Foundation avançada | RuntimeContentRuntime + lifecycle context | Risco de API pública prematura | Agora pode ser definido porque owner/context/lifecycle roots existem. |
...
| Lifecycle integration for runtime roots | Session/Route/Activity criam/removem roots/contextos explicitamente no lifecycle. | Teardown/setup espalhados | Integrar sem materializar prefab ainda | F8 | IF-FW-ROAD-8F |

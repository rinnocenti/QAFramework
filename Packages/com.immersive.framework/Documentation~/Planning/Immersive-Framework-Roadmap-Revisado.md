...
| IF-FW-ROAD-3C | `RouteContentRuntime` execution decision | APPLIED em F3D. Ativo e conectado ao `RouteLifecycleRuntime` para callbacks locais de Route Content na Primary Scene carregada. |

...
| F10 | `NOT STARTED` | Nenhum arquivo de runtime/editor deve tratar F10 como iniciado. |
| F10+ | `PROPOSED / PENDING HUMAN APPROVAL` | Sequencia abaixo e proposta; precisa de aprovacao humana antes de qualquer fase numerada iniciar. |
...
- estado de F10 como nao iniciado.
...
|---|---|---|---|
| F10 | Framework Core | Activity Entry/Exit Content Execution | `NOT STARTED` |
...
| Activity entry/exit content execution contracts | Framework Core | `PROPOSED F10` |
...
- Nao marcar F10 como iniciado antes de aprovacao humana.
...
Novos ADRs F10+ podem ser criados apenas quando:
...
Antes de iniciar F10, aprovar ou ajustar:

- o nome publico de F10;
- os contratos de Activity entry/exit content execution;
- a fronteira exata entre core logical execution e adapters fisicos;
- a lista minima de diagnostics/validation para F10;
- se algum ADR F10 novo deve ser criado antes da implementacao.

Enquanto isso, F10 permanece `NOT STARTED`.
